        ...
        <div className="container">
            <div className="row">
                <div>
                    ...
                    <div className="video-description">{props.selectedVideo.snippet.description}</div>
                    <div>
                ...
                <div>
                    <RelatedVideos relatedVideos={props.searchedVideos} getRelatedVideos={props.getRelatedVideos} chooseVideo={props.chooseVideo} submitVideoInfo={props.submitVideoInfo} ></RelatedVideos>
                </div>
            </div>
